...
const HeroSection = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // In a real application, you'd send this email to your backend/PocketBase
    // For this example, we'll just simulate a success message.
    if (email) {
      setMessage(`Thank you for signing up, ${email}! We'll notify you soon.`);
      setEmail('');
    } else {
  ...
  return (
    <div className="relative isolate mt-14 px-6 pt-14 lg:px-8">
      <div
      ...
      <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        <div className="text-center">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
            Unlock Your Creative Vision with Renevizion
          </h1>
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Master the art of visual storytelling and bring your ideas to life.
